...
SECRET_KEY = ')z^ike_4!2x!2#i5^1=&z41_naj2^_vg)x@^#k9-42okb03ef#'
...
#         'verbose': {
#             'format': '%(levelname)s %(asctime)s %(module)s %(lineno)d %(email)s'
#         },
#         'simple': {
#             'format': '%(levelname)s %(module)s %(lineno)d %(email)s'
#         },
#     },
#     'filters': {  # 对日志进行过滤
...
#             'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/meimall.log"),  # 日志文件的位置
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'NineThou_xq@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = '19940102wq'
# 收件人看到的发件人
EMAIL_FROM = '美多商城<NineThou_xq@163.com>'

# 指定FDFS客户端配置文件路径
FDFS_CLIENT_CONF = os.path.join(BASE_DIR, 'utils/fastdfs/client.conf')
FDFS_URL = 'http://192.168.117.136:8888/'
